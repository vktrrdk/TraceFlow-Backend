...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("realtime", sa.BigInteger(), nullable=True),
        sa.Column("cpu_percentage", sa.Float(precision=4), nullable=True),
        sa.Column("rchar", sa.BigInteger(), nullable=True),
        sa.Column("wchar", sa.BigInteger(), nullable=True),
        sa.Column("syscr", sa.BigInteger(), nullable=True),
        sa.Column("syscw", sa.BigInteger(), nullable=True),
        ...
        sa.Column("vmem", sa.BigInteger(), nullable=True),
        sa.Column("rss", sa.BigInteger(), nullable=True),
        sa.Column("peak_vmem", sa.BigInteger(), nullable=True),
        sa.Column("peak_rss", sa.BigInteger(), nullable=True),
        sa.Column("vol_ctxt", sa.BigInteger(), nullable=True),
        sa.Column("inv_ctxt", sa.BigInteger(), nullable=True),
        sa.Column("event", sa.String(), nullable=True),
    )
    ...
    op.create_table(
        ...
        sa.Column("succeeded_duration", sa.BigInteger(), nullable=True),
        sa.Column("cached_pct", sa.Float(precision=4), nullable=True),
        sa.Column("load_memory", sa.BigInteger(), nullable=True),
        ...
        sa.Column("peak_memory", sa.BigInteger(), nullable=True),
        ...
        sa.Column("cached_duration", sa.BigInteger(), nullable=True),
        sa.Column("aborted_count", sa.Integer(), nullable=True),
        sa.Column("failed_duration", sa.BigInteger(), nullable=True),
